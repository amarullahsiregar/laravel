    ...
    <div class="slider">
        @foreach ($dosens as $dosen)
            @switch($dosen->status_kehadiran)
                @case('Hadir')
                    <div class="border border-gray-400 rounded-lg shadow xl:rounded-xl mx-2 xl:mx-3 hadir    bg-emerald-500 text-white">
                    @break
                @case('Tidak Hadir')
                    <div class="border border-gray-400 rounded-lg shadow xl:rounded-xl mx-2 xl:mx-3 absen    bg-red-500 text-white ">
                    @break
                @case('Mengajar')
                    <div class="border border-gray-400 rounded-lg shadow xl:rounded-xl mx-2 xl:mx-3 mengajar text-white" style="background-color: #0288d1">
                    @break
                @default
