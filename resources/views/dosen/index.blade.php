            ...
            <div class="card">
                ...
                <table class="table table-flush dataTable-table m-5 border-2 " id="users-list">
                    <thead class="thead-light">
                        <tr class=" p-5 ">
                            <th data-sortable="" style="width: 12.07134%;"><a href="#" class="dataTable-sorter">No Induk</a></th>
                            <th data-sortable="" style="width: 15.2641%;"><a href="#" class="dataTable-sorter">Nama Dosen</a></th>
                            <th data-sortable="" style="width: 19.9625%;"><a href="#" class="dataTable-sorter">Email</a></th>
                            <th data-sortable="" style="width: 7.07134%;"><a href="#" class="dataTable-sorter">Inisial</a></th>
                            <th data-sortable="" style="width: 7.07134%;"><a href="#" class="dataTable-sorter">Edit</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($dosens as $dosen)
                        <tr>
                            <td class="text-sm text-center border">{{ $dosen->id }}</td>

                            <td class="text-sm pl-5 border">{{ $dosen->nama }}</td>
                            <td class="text-sm pl-5 border">{{ $dosen->email }}</td>
                            <td class="text-sm pl-5 border">{{ $dosen->inisial_dosen }}</td>
                            <td class="text-sm pl-5 border">
                                <a href="/dosen/{{ $dosen->email }}" class="mx-3 p-auto" data-bs-toggle="tooltip" data-bs-original-title="Edit user">
